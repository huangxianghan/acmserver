    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          <li><a href="javascript:disconnect()"><span class="am-icon-user"></span> 资料</a></li>
          <li><a href="javascript:connect()"><span class="am-icon-cog"></span> 设置</a></li>
          <li><a href="<%=path%>/adminlogout"><span class="am-icon-power-off"></span> 退出</a></li>
        </ul>
      </li>
